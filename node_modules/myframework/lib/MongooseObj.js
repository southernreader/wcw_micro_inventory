...
function MongooseObj(config) {	
	...
	//this.mongoose = Mongoose.connect(config.uri, function(err) {
	console.log(require("envar")("mongodb_uri"));
	this.mongoose = Mongoose.connect(require("envar")("mongodb_uri"), config.options, function(err) {
	    if (err) throw err;
	});
}
